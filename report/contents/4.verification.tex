\chapter{Bounded Model Checking on s2n Using CBMC}
...
% function: s2n_timer_start
% function: s2n_timer_elapsed
% function: s2n_timer_reset

% case 1: failed at pointer check:  int s2n_timer_*(null, null [, nanoseconds])
...
% \subsection{Notices}
% Quantifier & unwind:
% Quantifier value should be the same as unwind number
