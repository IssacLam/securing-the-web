...
\documentclass[11pt, beltcrest, fleqn, twoside]{ociamthesis} % use old belt crest logo
% \documentclass[12pt,shieldcrest]{ ociamthesis} % use older shield crest logo
\newcounter{filePrg}

\usepackage[dvipsnames]{xcolor}

\usepackage[skins,minted,many]{tcolorbox}
...
\newtcbinputlisting[use counter=filePrg, number within=section, list inside=mypyg]{\codeFromFileBreak}[5][]{%
  listing engine=minted,
  minted language=#2,
  listing file={#3},
  minted options={autogobble,linenos,breaklines,tabsize=4,fontsize=\footnotesize,#1},
...
worldRed/.style={circle,draw,minimum size=0.5cm,fill=red!15},
worldPurple/.style={circle,draw,minimum size=0.5cm,fill=blue!15},
worldGreen/.style={circle,draw,minimum size=0.5cm,fill=green!15},
...
self/.style={->,loop,looseness=10,in=30,out=330},
